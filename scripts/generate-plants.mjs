...
const originCountries = {
  ...
  Europe: ["GBR", "IRL", "FRA", "ESP", "PRT", "DEU", "ITA", "GRC", "POL", "NLD", "BEL", "CHE", "AUT", "CZE", "SVK", "HUN", "ROU", "BGR", "HRV", "SRB", "BIH", "MNE", "SVN", "MDA", "UKR"],
  ...
  "Southern South America": ["ARG", "CHL", "URY", "PRY", "BRA"],
  "Andean South America": ["COL", "ECU", "PER", "BOL", "CHL", "ARG"],
  "Southern Africa": ["ZAF", "LSO", "SWZ", "NAM", "BWA", "ZWE", "MOZ"],
  Australia: ["AUS"],
  "New Zealand": ["NZL"],
  "Australia and New Zealand": ["AUS", "NZL"],
  Japan: ["JPN"],
  Korea: ["KOR", "PRK"],
  "Indian Subcontinent": ["IND", "PAK", "BGD", "LKA", "NPL", "BTN"],
...
const supplementalBases = [
  ...
  ["Lemon Verbena", "Aloysia citrodora", "herbs", "tender annual herb", 8, 11, "Full sun", "Moderate water", "Southern South America"],
  ["Stevia", "Stevia rebaudiana", "herbs", "tender annual herb", 9, 11, "Full sun", "Even moisture", "Southern South America"],
  ["Yerba Mate", "Ilex paraguariensis", "herbs", "evergreen shrub", 9, 11, "Part shade", "Even moisture", "Southern South America"],
  ["Brazilian Peppertree", "Schinus terebinthifolia", "herbs", "small tree", 9, 11, "Full sun", "Low water", "South America"],
  ["Chilean Mint", "Mentha pulegium", "herbs", "perennial herb", 5, 9, "Sun to part shade", "Moist soil", "Southern South America"],
  ["Argentine Oregano", "Lippia integrifolia", "herbs", "tender annual herb", 9, 11, "Full sun", "Low water", "Southern South America"],
  ["Petunia", "Petunia integrifolia", "flowers", "annual flower", 9, 11, "Full sun", "Moderate water", "Southern South America"],
  ["Tall Verbena", "Verbena bonariensis", "flowers", "perennial flower", 7, 11, "Full sun", "Low water", "Southern South America"],
  ["Blue Anise Sage", "Salvia guaranitica", "flowers", "perennial flower", 7, 10, "Full sun", "Moderate water", "Southern South America"],
  ["Argentine Vervain", "Glandularia peruviana", "flowers", "annual flower", 8, 11, "Full sun", "Low water", "Southern South America"],
  ["Scarlet Sage", "Salvia splendens", "flowers", "annual flower", 9, 11, "Full sun", "Moderate water", "South America"],
  ["Princess Flower", "Tibouchina urvilleana", "flowers", "tender annual shrub", 9, 11, "Full sun", "Even moisture", "South America"],
  ["Four O'Clock", "Mirabilis jalapa", "flowers", "annual flower", 7, 11, "Full sun", "Moderate water", "South America"],
  ["Cape Gooseberry", "Physalis peruviana", "fruits", "warm-season annual", 8, 11, "Full sun", "Even moisture", "Andean South America"],
  ["Ground Cherry", "Physalis pruinosa", "fruits", "warm-season annual", 7, 11, "Full sun", "Even moisture", "South America"],
  ["Pepino Melon", "Solanum muricatum", "fruits", "warm-season annual", 9, 11, "Full sun", "Even moisture", "Andean South America"],
  ["Maqui Berry", "Aristotelia chilensis", "fruits", "fruit shrub", 7, 10, "Full sun", "Moderate water", "Southern South America"],
  ["Chilean Guava", "Ugni molinae", "fruits", "fruit shrub", 8, 10, "Sun to part shade", "Even moisture", "Southern South America"],
  ["Feijoa", "Acca sellowiana", "fruits", "fruit shrub", 8, 11, "Full sun", "Moderate water", "Southern South America"],
  ["Babaco", "Vasconcellea x heilbornii", "fruits", "warm-season annual", 9, 11, "Full sun", "Even moisture", "Andean South America"],
  ["Oca", "Oxalis tuberosa", "vegetables", "tuber crop", 7, 10, "Full sun", "Even moisture", "Andean South America"],
  ["Mashua", "Tropaeolum tuberosum", "vegetables", "tuber crop", 7, 10, "Full sun", "Even moisture", "Andean South America"],
  ["Ulluco", "Ullucus tuberosus", "vegetables", "tuber crop", 7, 10, "Sun to part shade", "Even moisture", "Andean South America"],
  ["Yacon", "Smallanthus sonchifolius", "vegetables", "tuber crop", 7, 10, "Full sun", "Even moisture", "Andean South America"],
  ["Pampas Grass", "Cortaderia selloana", "decorative", "grass", 7, 10, "Full sun", "Low water", "Southern South America"],
  ["Monkey Puzzle", "Araucaria araucana", "decorative", "conifer tree", 7, 10, "Full sun", "Moderate water", "Southern South America"],
  ["Chilean Firebush", "Embothrium coccineum", "decorative", "flowering tree", 7, 10, "Full sun", "Even moisture", "Southern South America"],
  ["Silver Torch Cactus", "Cleistocactus strausii", "decorative", "succulent", 9, 11, "Full sun", "Low water", "South America"],
  ["Rooibos", "Aspalathus linearis", "herbs", "tender annual herb", 9, 11, "Full sun", "Low water", "Southern Africa"],
  ["African Blue Basil", "Ocimum kilimandscharicum", "herbs", "annual herb", 9, 11, "Full sun", "Moderate water", "Africa"],
  ["Wild Rosemary", "Eriocephalus africanus", "herbs", "tender annual herb", 9, 11, "Full sun", "Low water", "Southern Africa"],
  ["African Daisy", "Osteospermum ecklonis", "flowers", "annual flower", 9, 11, "Full sun", "Low water", "Southern Africa"],
  ["Gazania", "Gazania rigens", "flowers", "annual flower", 9, 11, "Full sun", "Low water", "Southern Africa"],
  ["Gerbera Daisy", "Gerbera jamesonii", "flowers", "annual flower", 9, 11, "Full sun", "Moderate water", "Southern Africa"],
  ["Cape Leadwort", "Plumbago auriculata", "flowers", "tender annual shrub", 9, 11, "Full sun", "Moderate water", "Southern Africa"],
  ["Nerine Lily", "Nerine bowdenii", "flowers", "summer bulb", 7, 10, "Full sun", "Moderate water", "Southern Africa"],
  ["Agapanthus", "Agapanthus africanus", "flowers", "perennial flower", 7, 10, "Full sun", "Moderate water", "Southern Africa"],
  ["Watermelon", "Citrullus lanatus", "fruits", "warm-season annual", 8, 12, "Full sun", "Even moisture", "Southern Africa"],
  ["Kiwano", "Cucumis metuliferus", "fruits", "annual vine", 9, 12, "Full sun", "Even moisture", "Southern Africa"],
  ["Marula", "Sclerocarya birrea", "fruits", "fruit tree", 10, 12, "Full sun", "Low water", "Southern Africa"],
  ["Amaranth", "Amaranthus cruentus", "vegetables", "warm-season annual", 8, 12, "Full sun", "Moderate water", "Africa"],
  ["Cowpea", "Vigna unguiculata", "vegetables", "warm-season annual", 8, 12, "Full sun", "Low water", "Africa"],
  ["King Protea", "Protea cynaroides", "decorative", "flowering shrub", 9, 11, "Full sun", "Low water", "Southern Africa"],
  ["Bird of Paradise", "Strelitzia reginae", "decorative", "tender annual foliage", 9, 11, "Full sun", "Moderate water", "Southern Africa"],
  ["Jade Plant", "Crassula ovata", "decorative", "tender annual succulent", 10, 12, "Full sun", "Low water", "Southern Africa"],
  ["Cape Restio", "Elegia capensis", "decorative", "grass", 8, 10, "Full sun", "Moderate water", "Southern Africa"],
  ["Natal Plum", "Carissa macrocarpa", "decorative", "tender annual shrub", 9, 11, "Full sun", "Moderate water", "Southern Africa"],
  ["New Zealand Spinach", "Tetragonia tetragonioides", "vegetables", "warm-season annual", 8, 11, "Full sun", "Moderate water", "Australia and New Zealand"],
  ["Horopito", "Pseudowintera colorata", "herbs", "evergreen shrub", 8, 10, "Part shade", "Even moisture", "New Zealand"],
  ["New Zealand Celery", "Apium prostratum", "herbs", "tender annual herb", 8, 11, "Full sun", "Even moisture", "New Zealand"],
  ["New Zealand Wineberry", "Rubus cissoides", "fruits", "berry shrub", 8, 10, "Sun to part shade", "Even moisture", "New Zealand"],
  ["Bush Lawyer Berry", "Rubus australis", "fruits", "berry vine", 8, 10, "Sun to part shade", "Even moisture", "New Zealand"],
  ["Mountain Pepper", "Tasmannia stipitata", "herbs", "evergreen shrub", 7, 10, "Part shade", "Even moisture", "Australia"],
  ["Anise Myrtle", "Syzygium anisatum", "herbs", "tender annual shrub", 9, 11, "Sun to part shade", "Even moisture", "Australia"],
  ["Lemon Myrtle", "Backhousia citriodora", "herbs", "tender annual shrub", 9, 11, "Full sun", "Even moisture", "Australia"],
  ["Kakabeak", "Clianthus puniceus", "flowers", "flowering shrub", 8, 11, "Full sun", "Moderate water", "New Zealand"],
  ["Kangaroo Paw", "Anigozanthos flavidus", "flowers", "annual flower", 9, 11, "Full sun", "Low water", "Australia"],
  ["Swan River Daisy", "Brachyscome iberidifolia", "flowers", "annual flower", 8, 11, "Full sun", "Moderate water", "Australia"],
  ["Billy Buttons", "Craspedia globosa", "flowers", "annual flower", 8, 11, "Full sun", "Low water", "Australia and New Zealand"],
  ["Muntries", "Kunzea pomifera", "fruits", "fruit shrub", 8, 11, "Full sun", "Low water", "Australia"],
  ["Tasmanian Pepperberry", "Tasmannia lanceolata", "fruits", "fruit shrub", 7, 10, "Part shade", "Even moisture", "Australia"],
  ["Finger Lime", "Citrus australasica", "fruits", "citrus tree", 9, 11, "Full sun", "Even moisture", "Australia"],
  ["Kakadu Plum", "Terminalia ferdinandiana", "fruits", "fruit tree", 10, 12, "Full sun", "Moderate water", "Australia"],
  ["Warrigal Greens", "Tetragonia implexicoma", "vegetables", "warm-season annual", 8, 11, "Full sun", "Moderate water", "Australia and New Zealand"],
  ["Kawakawa", "Piper excelsum", "decorative", "evergreen shrub", 8, 11, "Part shade", "Even moisture", "New Zealand"],
  ["New Zealand Flax", "Phormium tenax", "decorative", "grass", 8, 11, "Full sun", "Moderate water", "New Zealand"],
  ["Cabbage Tree", "Cordyline australis", "decorative", "evergreen tree", 8, 11, "Full sun", "Moderate water", "New Zealand"],
  ["Wollemi Pine", "Wollemia nobilis", "decorative", "conifer tree", 8, 11, "Sun to part shade", "Even moisture", "Australia"],
  ["Bottlebrush", "Callistemon citrinus", "decorative", "flowering shrub", 8, 11, "Full sun", "Moderate water", "Australia"],
  ["Snow Gum", "Eucalyptus pauciflora", "decorative", "evergreen tree", 7, 10, "Full sun", "Moderate water", "Australia"],
  ["Mitsuba", "Cryptotaenia japonica", "herbs", "perennial herb", 4, 8, "Part shade", "Moist soil", "Japan"],
  ["Wasabi", "Eutrema japonicum", "herbs", "perennial herb", 7, 10, "Part shade", "Moist soil", "Japan"],
  ["Japanese Mugwort", "Artemisia princeps", "herbs", "perennial herb", 4, 9, "Full sun", "Moderate water", "Japan"],
  ["Perilla", "Perilla frutescens var. crispa", "herbs", "annual herb", 7, 11, "Sun to part shade", "Even moisture", "Korea"],
  ["Komatsuna", "Brassica rapa var. perviridis", "vegetables", "cool-season annual", 3, 9, "Full sun", "Even moisture", "Japan"],
  ["Mizuna", "Brassica rapa var. nipposinica", "vegetables", "cool-season annual", 3, 9, "Full sun", "Even moisture", "Japan"],
  ["Daikon", "Raphanus sativus var. longipinnatus", "vegetables", "root crop", 3, 10, "Full sun", "Even moisture", "Japan"],
  ["Burdock", "Arctium lappa", "vegetables", "root crop", 3, 9, "Full sun", "Even moisture", "Japan"],
  ["Napa Cabbage", "Brassica rapa subsp. pekinensis", "vegetables", "cool-season biennial", 3, 9, "Full sun", "Even moisture", "China"],
  ["Bok Choy", "Brassica rapa subsp. chinensis", "vegetables", "cool-season biennial", 3, 9, "Full sun", "Even moisture", "China"],
  ["Korean Melon", "Cucumis melo var. makuwa", "fruits", "warm-season annual", 8, 11, "Full sun", "Even moisture", "Korea"],
  ["Asian Plum", "Prunus salicina", "fruits", "fruit tree", 5, 9, "Full sun", "Moderate water", "Japan"],
  ["Satsuma Mandarin", "Citrus unshiu", "fruits", "citrus tree", 8, 11, "Full sun", "Moderate water", "Japan"],
  ["Japanese Quince", "Chaenomeles japonica", "fruits", "fruit shrub", 5, 9, "Full sun", "Moderate water", "Japan"]
  ,["Holy Basil", "Ocimum tenuiflorum", "herbs", "annual herb", 9, 12, "Full sun", "Even moisture", "Indian Subcontinent"],
  ["Turmeric", "Curcuma longa", "herbs", "tropical herb", 8, 11, "Sun to part shade", "Even moisture", "Indian Subcontinent"],
  ["Ginger", "Zingiber officinale", "herbs", "tropical herb", 8, 11, "Part shade", "Even moisture", "Indian Subcontinent"],
  ["Green Cardamom", "Elettaria cardamomum", "herbs", "tender annual herb", 10, 12, "Part shade", "Moist soil", "Indian Subcontinent"],
  ["Ajwain", "Trachyspermum ammi", "herbs", "annual herb", 8, 11, "Full sun", "Low water", "Indian Subcontinent"],
  ["Indian Lotus", "Nelumbo nucifera", "flowers", "aquatic perennial", 4, 10, "Full sun", "Moist soil", "Indian Subcontinent"],
  ["Arabian Jasmine", "Jasminum sambac", "flowers", "tender annual vine", 9, 12, "Full sun", "Even moisture", "Indian Subcontinent"],
  ["Bitter Melon", "Momordica charantia", "vegetables", "annual vine", 9, 12, "Full sun", "Even moisture", "Indian Subcontinent"],
  ["Bottle Gourd", "Lagenaria siceraria", "vegetables", "annual vine", 8, 12, "Full sun", "Even moisture", "Indian Subcontinent"],
  ["Pigeon Pea", "Cajanus cajan", "vegetables", "warm-season annual", 9, 12, "Full sun", "Low water", "Indian Subcontinent"],
  ["Mango", "Mangifera indica", "fruits", "fruit tree", 10, 12, "Full sun", "Moderate water", "Indian Subcontinent"],
  ["Indian Gooseberry", "Phyllanthus emblica", "fruits", "fruit tree", 9, 12, "Full sun", "Moderate water", "Indian Subcontinent"],
  ["Banyan", "Ficus benghalensis", "decorative", "tender annual tree", 10, 12, "Full sun", "Moderate water", "Indian Subcontinent"],
  ["Neem", "Azadirachta indica", "decorative", "tender annual tree", 10, 12, "Full sun", "Low water", "Indian Subcontinent"]
];
